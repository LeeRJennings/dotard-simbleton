...
// grabs business objects for use in other files
export const getBusinesses = () => {
    return businesses
}

// creates a new array by filtering for objects that are in New York
export const newYorkBizArr = getBusinesses().filter(bizObj => bizObj.addressStateCode === 'NY')
